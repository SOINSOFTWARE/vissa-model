...
@DynamicUpdate
@SelectBeforeUpdate
public class Expense extends CommonData {
	...
	public static Builder builder(Expense lot) {
	...
	public static class Builder {
		...
		private Builder(Expense expense) {
			id(expense.getId()).creationDate(expense.getCreationDate()).modifyDate(expense.getModifyDate())
					.archived(expense.isArchived()).name(expense.name).expenseDate(expense.expenseDate)
